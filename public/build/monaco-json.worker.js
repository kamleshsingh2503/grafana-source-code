...
(function (Event) {
  ...
  function any() {
    ...
    return function (listener, thisArgs, disposables) {
      ...
      return _lifecycle_js__WEBPACK_IMPORTED_MODULE_2__["combinedDisposable"].apply(void 0, events.map(function (event) {
        return event(function (e) {
          return listener.call(thisArgs, e);
        }, null, disposables);
      }));
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dispose", function() { return _dispose; });
...
function isString(str) {
  if (_typeof2(str) === _typeof.string || str instanceof String) {
    return true;
  }
...
function isObject(obj) {
  ...
  return _typeof2(obj) === _typeof.object && obj !== null && !Array.isArray(obj) && !(obj instanceof RegExp) && !(obj instanceof Date);
}
/**
...
function isNumber(obj) {
  if ((_typeof2(obj) === _typeof.number || obj instanceof Number) && !isNaN(obj)) {
    return true;
  }
...
function isUndefined(obj) {
  return _typeof2(obj) === _typeof.undefined;
}
/**
...
function isFunction(obj) {
  return _typeof2(obj) === _typeof["function"];
}
...
var _pathSepMarker = _platform_js__WEBPACK_IMPORTED_MODULE_0__["isWindows"] ? 1 : undefined; // eslint-disable-next-line @typescript-eslint/class-name-casing
...
function (_super) {
  ...
  function SimpleWorkerClient(workerFactory, moduleId, host) {
    ...
    var hostMethods = _types_js__WEBPACK_IMPORTED_MODULE_3__["getAllMethodNames"](host); // Send initialize message
  ...
  EditorSimpleWorker.prototype.computeLinks = function (modelUrl) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        return [2
        /*return*/
        , Object(_modes_linkComputer_js__WEBPACK_IMPORTED_MODULE_10__["computeLinks"])(model)];
      });
    });
  };
