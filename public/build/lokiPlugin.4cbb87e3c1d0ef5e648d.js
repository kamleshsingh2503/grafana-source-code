  ...
  _createClass(LokiDatasource, [{
    ...
    value: function query(options) {
      ...
      filteredTargets.forEach(function (target) {
        return subQueries.push(_this2.runInstantQuery(target, options, filteredTargets.length), _this2.runRangeQuery(target, options, filteredTargets.length));
...
//# sourceMappingURL=lokiPlugin.4cbb87e3c1d0ef5e648d.js.map